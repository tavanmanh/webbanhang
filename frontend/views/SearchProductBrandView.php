...
<?php $brandId = isset($_GET["brandId"]) ? $_GET["brandId"] : 0;?>
                ...
                <div style="margin-top: -50px;"  class="&#x70;&#x61;&#x67;&#x69;&#x6E;&#x61;&#x74;&#x69;&#x6F;&#x6E;&#x2D;&#x63;&#x6F;&#x6E;&#x74;&#x61;&#x69;&#x6E;&#x65;&#x72;">
                    <ul class="pagination">
                        ...
                        <?php for($i = 1; $i <= $numPage; $i++): ?>
                            <li class="page-item"><a class="page-link" href="index.php?controller=search&action=productBrand&<?php if ($id) echo "id=$id"?>&brandId=<?php echo $brandId?><?php if ($toPrice) echo "&fromPrice=$fromPrice&toPrice=$toPrice"?><?php if ($key) echo "&key=$key"?>&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                        <?php endfor; ?>
                    </ul>
                </div>
                <!-- end paging -->
