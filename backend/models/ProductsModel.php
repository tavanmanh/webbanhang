<?php 
	trait ProductsModel{
		...
		public function modelUpdate($id){
			...
			$conn->query("update products set name='$name',description='$description',content='$content',hot=$hot,price=$price,discount=$discount,category_id=$category_id,brand_id=$brand_id where id=$id");
		...
		public function modelCreate(){
			...
			$conn = Connection::getInstance();
			//update du lieu tuong ung voi id truyen vao
			$conn->query("insert into products set name='$name',description='$description', time= '$timestamp',content='$content',hot=$hot,photo='$photo',photo1='$photo1',photo2='$photo2',photo3='$photo3',photo4='$photo4',photo5='$photo5',price=$price,discount=$discount,category_id=$category_id,brand_id= $brand_id");
		}
		//xoa ban ghi
        ...
        public function modelGetBrand($brand_id){
            //lay bien ket noi
            $conn = Connection::getInstance();
            $query = $conn->query("select name from brand where id=$brand_id");
            $result = $query->fetch();
            return isset($result->name) ? $result->name : "";
        }
